...
1. PIN (4 o 6 dígitos)
2. Contraseña simple (8+ alfanuméricos)
3. Tipo de usuario (admin | guest | user)
4. Código inventario INV-###...

El simulador permite:

- Cargar una entrada como cinta
- Seleccionar el tipo de Regex a validar
- Ejecutar la MT paso a paso
- Ejecutar la MT completa
